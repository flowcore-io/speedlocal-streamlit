...
class EnergyEmissionsModule_refactor(BaseModule):
    """Energy and Emissions visualization module."""
    ...
    def render(
        ...
        with energy_tab:
            self._render_section('energy_refactor', table_dfs, filters)
        
        with emissions_tab:
            self._render_section('emissions_refactor', table_dfs, filters)
